...
const localize = (locale) => {
  if (locale == "en") {
    return {
      newShelf: "New shelf",
      booksWithoutShelfs: "Books without shelfs",
      addShelf: "Add shelf",
      newShelfName: "New shelf name",
      deleteShelf: "Delete shelf",
      allBooks: "All books",
      allShelfs: "All shelfs",
      ...
      shelfs: "Shelfs",
      changeShelfsForBook: "Change shelfs for book: ",
      close: "Close",
      clear: "Clear",
    ...
    return {
      ...
      shelfs: "Полки",
      changeShelfsForBook: "Редактировать полки для книги",
      close: "Закрыть",
      clear: "Очистить",
